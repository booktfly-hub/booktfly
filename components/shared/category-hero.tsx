...
export function CategoryHero({ eyebrow, title, description, image }: CategoryHeroProps) {
  return (
    <section className="relative isolate flex min-h-[380px] items-end overflow-hidden bg-slate-950 px-3 pb-20 pt-36 sm:min-h-[420px] sm:px-6 sm:pb-24 sm:pt-40 lg:px-8">
      <Image
        src={image}
        alt=""
        fill
