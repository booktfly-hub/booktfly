    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-background">
        ...
        >
          ...
          <h2 className="text-3xl font-black text-foreground mb-4 tracking-tight">{t('reset_link_sent')}</h2>
          ...
          >
            <BackArrow className="me-2 w-5 h-5" />
            {t('back_to_login')}
          </Link>
        </motion.div>
      </div>
            ...
            >
              <Link href={`/${locale}`} className="inline-flex items-center justify-start mb-10 group">
                <Image
                  ...
                  height={72}
                  priority
                  className="h-14 w-auto object-contain drop-shadow-[0_2px_10px_rgba(255,255,255,0.12)] transition-transform duration-300 group-hover:scale-[1.02]"
                />
              </Link>
            </motion.div>
        ...
        <div className="w-full lg:w-7/12 p-6 sm:p-12 lg:p-16 flex flex-col justify-center relative bg-card">
          <div className="max-w-md w-full mx-auto">
            <div className="text-center lg:text-start mb-8 lg:mb-10">
              <Link href={`/${locale}`} className="lg:hidden inline-flex mb-8 group">
                <Image
                  ...
                  height={72}
                  priority
                  className="h-12 w-auto object-contain drop-shadow-[0_2px_8px_rgba(var(--primary-rgb),0.15)] transition-transform duration-300 group-hover:scale-[1.02]"
                />
              </Link>
              ...
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
              >
                <h1 className="text-3xl font-extrabold tracking-tight text-foreground mb-3">{t('reset_password')}</h1>
                <p className="text-muted-foreground font-medium">{t('reset_password_description')}</p>
              </motion.div>
            </div>
            ...
            >
              <Link
                href={`/${locale}/auth/login`}
                className="text-primary font-black hover:text-primary/80 transition-colors inline-flex items-center gap-2 group"
              >
                <BackArrow className={cn(
                  "w-5 h-5 transition-transform duration-300 group-hover:-translate-x-1",
                  locale === 'ar' && "rotate-180 group-hover:translate-x-1"
                )} />
                {t('back_to_login')}
