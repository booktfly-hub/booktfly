    ...
    <div className="space-y-8 animate-fade-in-up">
      <div>
        ...
        <p className="text-slate-500 font-medium mt-1">
          {isAr ? 'تواصل مع العملاء' : 'Communicate with customers'}
        </p>
      </div>
      ...
      <div className="bg-white border border-slate-200 rounded-[2rem] shadow-sm">
        <div className="flex flex-col items-center justify-center py-32 text-center px-6">
          ...
          <p className="text-slate-500 max-w-sm leading-relaxed">
            {isAr
              ? 'ميزة المحادثات قيد التطوير وستكون متاحة قريباً. ستتمكن من التواصل مع العملاء مباشرة من هنا.'
              : 'The chat feature is currently under development and will be available soon. You will be able to communicate directly with customers from here.'}
          </p>
